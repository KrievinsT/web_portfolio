        ...
        <div className="services-grid">
          ...
          <div className="security-section">
            <div className="security-icon">
              <img 
                src="https://cdn.prod.website-files.com/6700f419829e38664506b649/67062e524dc8385304da9f45_feature-icon-01.svg" 
                alt="Shield" 
                className="icon" 
              />
            </div>
          ...
          <div className="service-item">
            <div className="service-icon">
              <img 
                src="https://cdn.prod.website-files.com/6700f419829e38664506b649/67062e3f3c0f63393c694453_feature-icon-02.svg" 
                alt="Dollar Sign" 
                className="icon" 
              />
            </div>
          ...
          <div className="service-item">
            <div className="service-icon">
              <img 
                src="https://cdn.prod.website-files.com/6700f419829e38664506b649/67062e3f6f3052c5cdcbba21_feature-icon-03.svg" 
                alt="Line Chart" 
                className="icon" 
              />
            </div>
          ...
          <div className="service-item">
            <div className="service-icon">
              <img 
                src="https://cdn.prod.website-files.com/6700f419829e38664506b649/67062e3f293d219c3ce94766_feature-icon-04.svg" 
                alt="Settings" 
                className="icon" 
              />
            </div>
